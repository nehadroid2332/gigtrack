...
class _AddInstrumentScreenState
  ...
  List<SubInstrumentNotes> subInstruments = [];
  ...
  SubInstrumentNotes subInstrument;
                            ...
                            RaisedButton(
                              onPressed: () {
                                setState(() {
                                  ...
                                  subInstrument.id = randomString(12);
                                  subInstrument.createdDate =
                                      DateTime.now().millisecondsSinceEpoch;
                                  subInstruments.add(subInstrument);
                                  presenter.addSubInstrumentNote(
                                      subInstruments, widget.id);
                                  subInstrument = null;
                                });
                              },
...
//                                    ),
                            ...
                            ShowUp(
                              child: new GestureDetector(
                                onTap: () {
                                  setState(() {
                                    subInstrument = SubInstrumentNotes();
                                  });
                                },
                                child: Text(
                            ...
                            ListView.builder(
                              itemCount: subInstruments.length,
                              shrinkWrap: true,
                              itemBuilder: (BuildContext context, int index) {
                                SubInstrumentNotes notesTodo =
                                    subInstruments[index];
                                DateTime dateTime =
  ...
  void getInstrumentDetails(UserInstrument instrument) {
    ...
    setState(() {
      ...
      subInstruments = instrument.subNotes;
