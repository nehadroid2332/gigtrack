                        ...
                        Expanded(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                                ...
                                child: !_isnickNameEuip
                                  ...
                                  child: widget.id.isEmpty
                                    ...
                                    style: textTheme.display1
                                        .copyWith(
                                        color:qDarkmodeEnable?Colors.red: Colors.red,
                                        fontSize: 16),
                                  )
                                      : Container(),
                                )
                              ...
                              widget.id.isEmpty&& !_isnickNameEuip? Container(
                                height: 1,
                              ...
                              widget.id.isEmpty || isEdit
                                ...
                                delay: 1000,
                                  ...
                                  : Container(),
                              widget.id.isEmpty&& !_ispurchaseDate? Container(
                                height: 1,
                                width: MediaQuery.of(context).size.width/4,
                                color: Colors.red,
                                margin: EdgeInsets.only(
...
//                                    ),
                              ...
                              widget.id.isEmpty&& !_iswarrantyAvailable? Container(
                                height: 1,
                                width: MediaQuery.of(context).size.width/4,
                                color: Colors.red,
                                margin: EdgeInsets.only(
                                ...
                                child: Column(
                                  children: <Widget>[
                                   ...
                                   Container(
                                    ...
                                    widget.id.isEmpty&&!_iswarrantydate? Container(
                                      height: 1,
                              ...
                              widget.id.isEmpty&& !_isinsuranceInfo? Container(
                                height: 1,
                                width: MediaQuery.of(context).size.width/4,
                                color: Colors.red,
                                margin: EdgeInsets.only(
